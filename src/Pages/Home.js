...
export const Home=()=>{
    ...
    <div className=" bg-transparent  dark:text-white">
        ...
        <div className="flex justify-center">
            ...
            <div>
                <Link  to='/AboutUs'>
                <button className="ring-1 ring-blue-700 bg-blue-400 rounded-full p-1 m-1 focus:ring-blue-100 focus:ring-0">
            ...
            <div>
                <Link to='/Help'>
                <button className="ring-1 ring-pink-700 bg-pink-400 rounded-full p-1 m-1 focus:ring-blue-100 focus:ring-0">
            ...
            <div>
                <Link to='/Category'>
                <button 
                    className="ring-1 ring-green-400 bg-green-400 rounded-full p-1 m-1 focus:ring-blue-100 focus:ring-0">
            ...
            <div>
                <Link to='/Wallet'>
                <button className="ring-1 ring-blue-800 bg-blue-600 rounded-full p-1 m-1 focus:ring-blue-100 focus:ring-0">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M21 12a2.25 2.25 0 0 0-2.25-2.25H15a3 3 0 1 1-6 0H5.25A2.25 2.25 0 0 0 3 12m18 0v6a2.25 2.25 0 0 1-2.25 2.25H5.25A2.25 2.25 0 0 1 3 18v-6m18 0V9M3 12V9m18 0a2.25 2.25 0 0 0-2.25-2.25H5.25A2.25 2.25 0 0 0 3 9m18 0V6a2.25 2.25 0 0 0-2.25-2.25H5.25A2.25 2.25 0 0 0 3 6v3" />
            ...
            <div>
                <Link to='/FAQ'>
                <button 
                    className="ring-1 ring-purple-900 bg-purple-500 rounded-full p-1 m-1 focus:ring-blue-100 focus:ring-0">
